...
function beforeLoad(context: EntryPoints.UserEvent.beforeLoadContext) {
    ...
    if (leaveRule) {
        ...
        let allowedPermissionHours = new LeaveRule().get(subsidiaryRuleId, [LeaveRuleField.PERMISSION_HOURS])[LeaveRuleField.PERMISSION_HOURS];
        ...
        let previousPermissions = new Permission()
            ...
            // .where(PermissionField.DATE, '>', today.setDate(0))
